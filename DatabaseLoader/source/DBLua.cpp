...
sol::table DatabaseLoader::DBLua::FloorData(lua_State* state, string name)
{
	return sol::table::create_with(state,
		...
		"Floor", 0,
		"Caption", [](string) {},
		"Tileset", (double) GetAsset("spr_floor_mask"),
		"Backgrounds", (double) GetAsset("spr_bg_3"),
		"ColorR", (double) 0,
		"ColorG", (double) 0,
		"ColorB", (double) 0,
		"Props", (double) GetAsset("spr_props1"),
		"BigBlock", (double) GetAsset("spr_bigblock1"),
		"GiantBlock", (double) GetAsset("spr_giantblock1"),
		"Fragile", (double) GetAsset("spr_fragile_block1"),
		"Door", (double) GetAsset("spr_lock"),
		"Rooms", [](string) {},
		"MinibossRooms", [](string) {},
		"DangerRooms", [](string) {},
		"LoopRooms", [](string) {},
		"ShortcutRooms", [](string) {},
		"MinibossAmount", (int) 1,
		"RoomsID", [](string) {},
		"Create", [](double) {},
		"Music", (string) "mus_floor6",
		"BossList", [](std::vector<double>) {},
		"ShouldForceFloor", (bool) false);
}
